...
export default function Home() {
  ...
  return (
    <Layout title="Overview">
      {/* Hero */}
      <div className="mb-8">
        <div className="flex items-center gap-2 text-cyber-accent text-xs tracking-widest mb-2">
          ◈ THREAT INTELLIGENCE PLATFORM
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">
          20 Years of Cyber Threats
        </h1>
        <p className="text-gray-400 max-w-2xl">
          Comprehensive analysis of cybersecurity attacks, vulnerabilities, and trends from 2005 to 2025.
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <StatCard label="Incidents Tracked" value={attacks.length} sub="2005–2025" icon="◎" />
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="card">
          <h2 className="section-title">📈 Attack Volume (2010–2024)</h2>
          {yearLabels.length > 0 && (
            <BarChart
              labels={yearLabels}
        ...
        <div className="card">
          <h2 className="section-title">💰 Financial Impact ($B)</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {Object.entries(insights.root_cause_distribution).map(([cause, pct]) => (
              <div key={cause} className="text-center p-3 bg-cyber-bg rounded-lg border border-cyber-border">
                <div className="text-2xl font-bold text-cyber-accent">{pct}%</div>
              ...
              <div key={i} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="h-1 bg-cyber-border rounded-full overflow-hidden">
                    <div className="h-full bg-orange-500 rounded-full" style={{ width: `${p.frequency * 2.5}%` }} />
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {[
          { href: '/timeline', label: 'Attack Timeline', desc: 'Interactive 20-year timeline', icon: '◈' },
