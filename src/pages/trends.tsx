  ...
  return (
    <Layout title="Trends Dashboard">
      ...
      <div className="card mb-6">
        <h2 className="section-title">📊 CVE Volume by Severity (2005–2026)</h2>
        <BarChart
          labels={years}
          datasets={[
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="card">
          ...
          <p className="text-xs text-gray-500 mt-2">
            Average days from CVE disclosure to active exploitation. Dropped from 45 days (2015) to near-zero by 2026.
          </p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <p className="text-xs text-gray-600 mt-3">
          * Predictions based on linear regression of 2015–2026 trend data. For planning purposes only.
        </p>
      </div>
    </Layout>
  )
